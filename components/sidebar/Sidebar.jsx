            ...
            <div className="h-full bg-white rounded-2xl dark:bg-gray-700">
                ...
                <nav className="mt-6">
                    <div>
                        ...
                        <Link className="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-blue-500" href="#">
                            <span className="text-left">
