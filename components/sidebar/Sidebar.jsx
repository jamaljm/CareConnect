            ...
            <div className="h-full bg-white rounded-2xl">
                ...
                <nav className="mt-6">
                    <div>
                        ...
                        <Link className="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 hover:text-blue-500 hover:border-blue-500 hoverbg-gradient-to-r hover:from-white hover:to-blue-100" href="/doctors">
                            <span className="text-left">
<img alt='' src="data:image/png;base64,"/>                            </span>
                        ...
                        <Link className="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 hover:text-blue-500" href="/ambulance">
                            <span className="text-left">
                        ...
                        <Link className="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 hover:text-blue-500" href="/medicine">
                            <span className="text-left">
