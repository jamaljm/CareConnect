...
export default function consultbaner() {
  return (
     <div className="w-full sm:w-1/2 xl:w-1/3">
                            <div className="">
                                <div className="w-full min-w-40 p-4 bg-[url('/images/signupbg.jpg')] bg-hero bg-no-repeat bg-cover bg-center rounded-t-2xl dark:bg-gray-700">
                  ...
                  <div className=''>
                    <h1 className="text-2xl font-semibold mt-64 text-white">Consult a doctor</h1>
                                    </div>
