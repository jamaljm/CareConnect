...
export default function Card4() {
  ...
  <div className="flex max-w-md bg-white shadow-lg rounded-lg overflow-hidden">
    <div className="w-1/3 bg-cover bg-[url('/images/doc4.jpg')] bg-hero bg-no-repeat bg-center ">
    </div> 
    <div className="w-2/3 p-4">
      <h1 className="text-black font text-xl">Dr Sandra Thomas</h1>
                  <p className="mt-2 text-gray-600 text-sm">Neurologist
        </p>
